  ...
  <DefaultLayout>
    ...
    <div class="grid grid-cols-1 gap-9 sm:grid-cols-2">
      <div class="flex flex-col gap-9">
        <!-- Contact Form Start -->
        <DefaultCard card-title="Contact Form">
          <form action="#">
            <div class="p-6.5">
              <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                <InputGroup
                  ...
                  custom-classes="w-full xl:w-1/2"
                />
      ...
      <div class="flex flex-col gap-9">
        <!-- Sign In Start -->
        <DefaultCard card-title="Sign In Form">
          <form action="#">
            <div class="p-6.5">
              <InputGroup
                label="Email"
        ...
        <!-- Sign Up Start -->
        <DefaultCard card-title="Sign Up Form">
          <form action="#">
            <div class="p-6.5">
              <InputGroup
                label="Name"
