  ...
  <DefaultLayout>
    ...
    <div class="grid grid-cols-1 gap-9 sm:grid-cols-2">
      <div class="flex flex-col gap-9">
        <!-- Input Fields Start -->
        <DefaultCard card-title="Input Fields">
        ...
        <DefaultCard card-title="Toggle switch input">
          <div class="flex flex-col gap-5.5 p-6.5">
            <SwitchOne />
            <SwitchTwo />
            <SwitchThree />
        ...
        <DefaultCard card-title="Time and date">
          <div class="flex flex-col gap-5.5 p-6.5">
            <DatePickerOne />
        ...
        <DefaultCard card-title="File upload">
          <div class="flex flex-col gap-5.5 p-6.5">
            <div>
              <label
                class="mb-3 block text-sm font-medium text-black dark:text-white"
      ...
      <div class="flex flex-col gap-9">
        ...
        <DefaultCard card-title="Textarea Fields">
          <div class="flex flex-col gap-5.5 p-6.5">
            <div>
              <label
                class="mb-3 block text-sm font-medium text-black dark:text-white"
        ...
        <!-- Checkbox and radio -->
        <DefaultCard card-title="Checkbox and radio">
          <div class="flex flex-col gap-5.5 p-6.5">
            <CheckboxOne />
            <CheckboxTwo />
            <CheckboxThree />
        ...
        <!-- Select input Start -->
        <DefaultCard card-title="Select input">
          <div class="flex flex-col gap-5.5 p-6.5">
            <SelectGroupOne />
